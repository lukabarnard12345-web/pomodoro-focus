...
export function VolumeIcon({ muted, size = 16, className }: IconProps & { muted: boolean }) {
  return muted ? (
...
export function MusicIcon({ size = 40, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className ?? 'text-white/20'}>
...
export function DragIcon({ size = 12, className }: IconProps) {
  return (
...
export { CloseIcon as DeleteIcon }
...
export function CheckIcon({ size = 8, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 10 8" fill="none" className={className}>
